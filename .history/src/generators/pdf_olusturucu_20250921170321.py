...
class PDFOlusturucu:
    ...
    def _grafik_elemanlari_olustur(
        ...
        for i in range(0, len(grafik_dosyalari), max_grafik_per_sayfa):
            ...
            if table_data:
                ...
                table = Table(table_data, colWidths=[4.7*inch, 4.7*inch])
    ...
    def _grafik_hucre_olustur(self, grafik_data: Tuple[Path, str]):
        ...
        try:
            ...
            # Başlıkları her zaman göster, teknik karakter kontrolü kaldırıldı
            # Eski kod:
            ...
            # Başlık varsa ekle - daha belirgin başlık stili
            if baslik:
    ...
    def _grafik_boyutu_hesapla(self, grafik_dosyasi: Path) -> Tuple[float, float]:
        ...
        try:
            ...
            max_genislik = 4.5 * inch  # Daha da geniş
            max_yukseklik = 3.7 * inch  # Daha da yüksek
