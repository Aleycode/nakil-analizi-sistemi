...
class NakilAnalizcisi:
    ...
    def kapsamli_gunluk_analiz(
        self, gun_tarihi: Optional[str] = None, baslangic_tarihi: Optional[str] = None
    ) -> Dict[str, Any]:
        """
        ...
        try:
            ...
            df_gunluk = self.veri_isleme.gunluk_zaman_araligi_filtrele(df, gun_tarihi, baslangic_tarihi)
