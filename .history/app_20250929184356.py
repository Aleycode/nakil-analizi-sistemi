...
def configure_page():
    ...
    st.markdown(
        ...
        /* Development araçlarını gizle */
        .reportview-container .sidebar .sidebar-content .element-container:has([data-testid="manage-app"]) {
            display: none !important;
        }
        
        /* Streamlit debugging araçlarını gizle */
        .reportview-container .main .block-container {
            padding-top: 1rem;
        }
        
        /* Manage app buttonunu gizle */
